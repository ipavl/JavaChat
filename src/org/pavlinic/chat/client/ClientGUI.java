...
public class ClientGUI extends JFrame implements ActionListener {
    ...
    final JFrame frame = new JFrame("jChat Client (Build " + Client.clientVer + " -- https://www.github.com/ipavl/javachat)");
    ...
    ClientGUI(String host, int port) {
        ...
        super("jChat Client (Build " + Client.clientVer + " -- https://www.github.com/ipavl/javachat)");
